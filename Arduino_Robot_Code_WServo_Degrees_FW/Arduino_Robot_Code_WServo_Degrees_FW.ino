...
double FindWall()
{
  ...
  while(ang<=170&&distance>=20);               //Change 40 to 20
    {
...
//  digitalWrite();  
    ...
    if (ang>=10&&ang<20)
  {
    Serial.println("Turning 75 degrees");
//  digitalWrite();
//  digitalWrite();
  }
    if (ang>25&&ang<35)
  {
    Serial.println("Turning 60 degrees");
//  digitalWrite();
//  digitalWrite();  
  }
    if (ang>40&&ang<50)
...
//digitalWrite();
    ...
    if (ang>160)
  {
    Serial.println("Turing 75 degrees");
//digitalWrite();
//digitalWrite();
  } 
...
//  digitalWrite(in3, HIGH);   //Right                              I think these are reversed but I would have to test it 
