...
void loop() 
{
  ...
  if (distance <20 && distance >10)                                   //If the distance is greater than 10 centimeters, then the motors will spin together in the same direction
  {
    delay (2000);
    digitalWrite(in1,HIGH);
    digitalWrite(in3,LOW);              //analogWrite
    digitalWrite(in2,LOW);
